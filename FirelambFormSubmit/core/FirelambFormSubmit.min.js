    ...
    $.fn.FirelambFormSubmit = function (options) {
        ...
        $(this).on("click", function () {
           ...
           // event.preventDefault();
            ...
            //if ($(opts.formId).data("ok")==true) {
            //    if (opts.submitType == "dirPost") {
            //        $(opts.formId).submit();
            //    }
            //    else if (opts.submitType == "ajaxPost") {
...
function loadEncrypt(encryptpe) {
    switch (encryptpe) {

        case "MD5":
            $.getScript("lib/CryptoJS/components/md5.js");
            break;
        case "SHA1":
            $.getScript("lib/CryptoJS/components/sha1.js");
            break;
        case "SHA256":
            $.getScript("lib/CryptoJS/rollups/SHA256.js");
            break;
        case "SHA3":
            $.getScript("lib/CryptoJS/rollups/SHA3.js");
            break;
        case "AES":
            $.getScript("lib/CryptoJS/rollups/AES.js");
            break;
        case "DES":
            $.getScript("lib/CryptoJS/rollups/tripledes.js");
            break;
        case "Rabbit":
            $.getScript("lib/CryptoJS/rollups/Rabbit.js");
            break;
        case "RC4":
            $.getScript("lib/CryptoJS/rollups/RC4.js");
            break;
    }
}
